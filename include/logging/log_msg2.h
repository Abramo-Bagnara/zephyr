...
#if __SIZEOF_LONG_DOUBLE__ == Z_LOG_MSG2_ALIGNMENT
typedef long double Z_LOG_Buffer_t;
#else
typedef long long Z_LOG_Buffer_t;
#endif
...
#define Z_LOG_MSG2_ON_STACK_ALLOC(ptr, len) \
	Z_LOG_Buffer_t _buf[ceiling_fraction(len, sizeof(Z_LOG_Buffer_t))]; \
